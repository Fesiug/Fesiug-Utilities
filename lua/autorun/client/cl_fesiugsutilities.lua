...
function FES_NPC_DMG( CPanel )
	...
	-- CPanel:AddControl("label",    {text =  "Absorb most damage types to your armor." })
	local dropdown = CPanel:ComboBox("Ablative Armor Mode", "fes_plymod_abarmor")
	dropdown:SetSortItems(false)
	dropdown:AddChoice("Disabled", 0)
	dropdown:AddChoice("Mode CE: Flinch", 1)
	dropdown:AddChoice("Mode 2: No flinch", 2)
	dropdown:AddChoice("Mode 3: Compatibility", 3)
